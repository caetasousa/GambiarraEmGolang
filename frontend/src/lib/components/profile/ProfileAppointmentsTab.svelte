<script lang="ts">
    // This component currently uses static data but is prepared for future dynamic props
...
<div class="animate-fade-in space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        >
            <div
                class="w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 mr-4"
            >
                <span class="material-symbols-outlined">calendar_today</span>
            </div>
            <div>
                <p class="text-sm text-gray-500 dark:text-gray-400">Hoje</p>
        ...
        >
            <div
                class="w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 bg-yellow-100 dark:bg-yellow-900/30 text-yellow-600 dark:text-yellow-400 mr-4"
            >
        ...
        >
            <div
                class="w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 mr-4"
            >
        ...
        >
            <div
                class="w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 mr-4"
            >
                        ...
                        <div>
                            <div class="flex items-center">
                                ...
                                <span
                                    ...
                                    >Corte de Cabelo + Hidratação</span
                                >
                            </div>
                            <p
                ...
                <div class="space-y-4">
                    ...
                    >
                        ...
                        <div>
                            ...
                            >
                                Beatriz M. agendou para amanhã às 14h
                            </p>
                            <p class="text-xs text-gray-400 mt-1">Há 15 min</p>
                        </div>
                    </div>
                    <div
                        class="flex items-start space-x-3 pb-4 border-b border-gray-100 dark:border-gray-800 last:border-0 last:pb-0"
